...
struct Transaction_Error {
  ...
  var category: Transaction_ErrorCategory = .none
...
struct Transaction_QueryResultItem {
  ...
  var error: Transaction_ErrorCategory {
...
extension Transaction_ErrorCategory: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "NONE"),
    1: .same(proto: "INSUFFICIENT_BALANCE"),
  ]
}
...
extension Transaction_QueryRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "type"),
    2: .same(proto: "param"),
    3: .same(proto: "exclusiveStartKey"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try decoder.decodeSingularStringField(value: &self.exclusiveStartKey)
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.exclusiveStartKey.isEmpty {
      try visitor.visitSingularStringField(value: self.exclusiveStartKey, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Transaction_QueryResultItem: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _error: Transaction_ErrorCategory = .none
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 4: try decoder.decodeSingularStringField(value: &_storage._payerID)
        case 5: try decoder.decodeSingularStringField(value: &_storage._recipientID)
        case 6: try decoder.decodeSingularEnumField(value: &_storage._status)
        case 7: try decoder.decodeSingularStringField(value: &_storage._note)
        case 8: try decoder.decodeSingularEnumField(value: &_storage._error)
        case 9: try decoder.decodeSingularStringField(value: &_storage._createdAt)
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._payerID.isEmpty {
        try visitor.visitSingularStringField(value: _storage._payerID, fieldNumber: 4)
      }
      if !_storage._recipientID.isEmpty {
        try visitor.visitSingularStringField(value: _storage._recipientID, fieldNumber: 5)
      }
      ...
      if _storage._error != .none {
        try visitor.visitSingularEnumField(value: _storage._error, fieldNumber: 8)
      }
